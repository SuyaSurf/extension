...
(function() {
  ...
  function injectUIElements(customData = null) {
    // Create Suya bot instead of traditional UI
    ...
    style.textContent = `
      #suya-bot {
        ...
        font-size: 24px;
        z-index: 9999;
        animation: suyaFloat 3s ease-in-out infinite;
      }
      ...
      #suya-bot.busy {
        animation: suyaPulse 2s ease-in-out infinite;
      }
      ...
      .suya-bubble {
        ...
        animation: suyaBubbleIn 0.3s ease-out;
        z-index: 10000;
        color: #333;
        font-size: 14px;
        line-height: 1.4;
    ...
    // Position Suya bot intelligently
    positionSuyaBot();
    ...
    overlay.id = 'suya-overlay';
    overlay.className = 'suya-overlay';
